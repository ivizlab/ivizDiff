        ...
        <div class="parameter-control">
          {#if getInputType(paramInfo as any) === 'checkbox'}
            ...
            <div class="flex items-center gap-3">
              ...
              />
              <label for="param-{controlnetIndex}-{paramName}" class="text-sm font-medium" title={(paramInfo as any).description || ''}>
          ...
          {:else if getInputType(paramInfo as any) === 'range'}
            ...
            <div class="space-y-1">
              <div class="flex items-center justify-between">
                <label for="param-{controlnetIndex}-{paramName}" class="text-xs font-medium text-gray-600 dark:text-gray-400" title={(paramInfo as any).description || ''}>
                  {formatParameterName(paramName)}
                </label>
                <input
                  type="number"
          ...
          {:else}
            <!-- Text parameter -->
            <div class="space-y-1">
              <label for="param-{controlnetIndex}-{paramName}" class="text-xs font-medium text-gray-600 dark:text-gray-400 block" title={(paramInfo as any).description || ''}>
                {formatParameterName(paramName)}
              </label>
              <input
                type="text"
